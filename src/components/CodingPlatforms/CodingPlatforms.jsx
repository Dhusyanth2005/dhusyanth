// src/components/CodingPlatforms/CodingPlatforms.jsx
...
const CodingPlatforms = () => {
  ...
  const platforms = [
    {
      ...
      stats: [
        ...
        { label: 'Contest Rating', value: '1547' }
      ],
      color: '#FFA116',
      profileUrl: 'https://leetcode.com/u/Dhusyanth20/', // ← Replace with your real LeetCode profile
      logo: (
    ...
    },
    {
      ...
      color: '#2EC866',
      profileUrl: 'https://www.hackerrank.com/profile/dhusyanth_s20231', // ← Replace with your real HackerRank profile
      logo: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      name: 'CodeChef',
      stats: [
        { label: 'Rating', value: '901' },
        { label: 'Contests', value: '6' },
        { label: 'Problems Solved', value: '100+' }
      ],
      color: '#795135',
      profileUrl: 'https://www.codechef.com/users/dhusyanths2005', // ← Replace with your real CodeChef handle
      logo: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      <div className={styles.logoWrapper}>
        <img 
          src="../images/skillrack.jpg" 
          alt="SkillRack Logo" 
          className={styles.logoskillrack} 
        />
      </div>
      )
    }
  ...
  const activePlatform = platforms.find(p => p.id === activeCard);

  return (
    <section id="coding" className={styles.codingPlatforms}>
          ...
          {platforms.map(platform => (
            ...
            >
              <div className={styles.platformFront}>
                <div className={styles.logoWrapper}>
                  <div className={styles.logoIcon} style={{ color: platform.color }}>
                    {platform.logo}
                  </div>
                </div>
      ...
      {activeCard !== null && activePlatform && (
        <div className={styles.modalOverlay}>
          ...
          >
            ...
            <div className={styles.platformHeader}>
              <div className={styles.headerLogo} style={{ color: activePlatform.color }}>
                {activePlatform.logo}
              </div>
              <h3 className={styles.headerName}>{activePlatform.name}</h3>
            </div>
